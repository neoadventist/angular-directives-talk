...
angular.module("template/datepicker/datepicker.html", []).run(["$templateCache", function($templateCache) {
    $templateCache.put("template/datepicker/datepicker.html",
        "<table>\n" +
            ...
            "      <th><button type=\"button\" class=\"btn pull-left\" ng-click=\"move(-1)\"><span class=\"glyphicon glyphicon-chevron-left\"></span></button></th>\n" +
            "      <th colspan=\"{{rows[0].length - 2 + showWeekNumbers}}\"><button type=\"button\" class=\"btn btn-block\" ng-click=\"toggleMode()\"><strong>{{title}}</strong></button></th>\n" +
            "      <th><button type=\"button\" class=\"btn pull-right\" ng-click=\"move(1)\"><span class=\"glyphicon glyphicon-chevron-right\"></span></button></th>\n" +
            "    </tr>\n" +
            ...
            "        <button type=\"button\" style=\"width:100%;\" class=\"btn\" ng-class=\"{'btn-primary': dt.selected}\" ng-click=\"select(dt.date)\" ng-disabled=\"dt.disabled\"><span ng-class=\"{muted: dt.secondary}\">{{dt.label}}</span></button>\n" +
            "      </td>\n" +
            "    </tr>\n" +
            "  </tbody>\n" +
            "</table>\n" +
